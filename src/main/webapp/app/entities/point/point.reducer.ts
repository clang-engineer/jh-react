...
export const ACTION_TYPES = {
  SEARCH_POINTS: 'point/SEARCH_POINTS',
...
export const getSearchEntities: ICrudSearchAction<IPoint> = (query, page, size, sort) => ({
  type: ACTION_TYPES.SEARCH_POINTS,
  payload: axios.get<IPoint>(`${apiSearchUrl}?query=${query}${sort ? `&page=${page}&size=${size}&sort=${sort}` : ''}`),
});
