  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterReactApp.point.home.createOrEditLabel" data-cy="PointCreateUpdateHeading">
            <Translate contentKey="jhipsterReactApp.point.home.createOrEditLabel">Create or edit a Point</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : pointEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="titleLabel" for="point-title">
                  <Translate contentKey="jhipsterReactApp.point.title">Title</Translate>
                </Label>
                <AvField
                  id="point-title"
                  data-cy="title"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="point-description">
                  <Translate contentKey="jhipsterReactApp.point.description">Description</Translate>
                </Label>
                <AvField
